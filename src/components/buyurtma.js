...
export const MenuBuyutma = () => {
    ...
    const addSumm = (id) => {
        const newProdact = { count: 1, prodact: tutorials[id - 1] };
            ...
            <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                ...
                >
                    ...
                    >
                        ...
                        <Box
                            sx={{
                                backgroundColor: isActive === 5 ? "#fff" : "",
                                px: 4,
                                py: "8px",
                                borderRadius: 10,
                                boxShadow:
                ...
                >
                    <Box sx={{ width: "24%" }}>
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                            ...
                            >
                                {dataUser.filter((item) => item.status === "Yangi").length}
                            </Typography>
                        </Box>
                        <Box
                            sx={{
                    ...
                    <Box sx={{ width: "24%" }}>
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                            ...
                            >
                                {
                                    dataUser.filter((item) => item.status === "Qabul qilingan")
                                        .length
                                }
                            </Typography>
                        </Box>
                    ...
                    <Box sx={{ width: "24%" }}>
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                            ...
                            >
                                {dataUser.filter((item) => item.status === "Jonatilgan").length}
                            </Typography>
                        </Box>
                        <Box
                            sx={{
                    ...
                    <Box sx={{ width: "24%" }}>
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                            ...
                            >
                                {dataUser.filter((item) => item.status === "Yopilgan").length}
                            </Typography>
                        </Box>
                        <Box
                            sx={{
                    ...
                    <Box sx={{ width: "24%" }}>
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                            ...
                            >
                                {
                                    dataUser.filter((item) => item.status === "Rad etilgan")
                                        .length
                                }
                            </Typography>
                        </Box>
                      ...
                      <span
                          style={{
                              padding: "0 20px",
                              backgroundColor:
                                  item.status === "Rad etilgan" ? "#20D472" : "",
                              borderRadius: "20px",
                              color: "#fff",
                              fontWeight: "bold",
                          }}
